                ...
                <tr>
                    ...
                    <td class="col">
                        <a href="javascript:void(0)" onclick="if(confirm('Are You sure to delete this record?')){document.querySelector('#delete-article-<?php echo $article['article_id'] ?>').submit();} else {return false}"
                            class="text-danger col" id="delete-btn" style="text-decoration: none;">
                        ...
                        <a href="update.php?article_id=<?= $article['article_id']?>" class="col mx-1 text-success" style="text-decoration: none;"><i class="fa-solid fa-pen"></i></a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
